...
public class LegendTag extends Tags {

    public LegendTag() {
        super(StringUtil.format("&5Legend &7Tag"));
    }

    @Override
    public String getName() {
        return StringUtil.format("&5Legend &7Tag");
    }
    ...
    public String getPermission() {
        return "fall.tags.legendary.legend";
    }
    ...
    public ItemStack getIcon() {
        ...
        itemMeta.setDisplayName(StringUtil.format("&5Legend &7Tag"));
