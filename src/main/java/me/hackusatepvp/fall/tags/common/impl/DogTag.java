...
public class DogTag extends Tags {

    public DogTag() {
        super(StringUtil.format("&aDog &7Tag"));
    }

    @Override
    public String getName() {
        return StringUtil.format("&aDog &7Tag");
    }
    ...
    public ItemStack getIcon() {
        ...
        itemMeta.setDisplayName(StringUtil.format("&aDog &7Tag"));
