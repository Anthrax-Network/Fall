...
public class BerserkerQuest extends Quest {

    public BerserkerQuest() {
        super("Berserker");
    }
    ...
    public String rankUpMessage() {
        return StringUtil.format("&7You have ranked up to &6BERSERKER&7.");
    }

    @Override
    public String getPrefix() {
        return StringUtil.format("&7[&6&lBerserker&7]");
    }
