...
public class OofTag extends Tags {

    public OofTag() {
        super(StringUtil.format("&eOof &7Tag"));
    }

    @Override
    public String getName() {
        return StringUtil.format("&eOof &7Tag");
    }
    ...
    public ItemStack getIcon() {
        ...
        itemMeta.setDisplayName(StringUtil.format("&eOof &7Tag"));
