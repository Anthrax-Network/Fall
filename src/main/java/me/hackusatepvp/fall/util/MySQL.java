        ...
        if (!isConnected()) {
            try {
                ...
                PreparedStatement profiles = this.getConnection().prepareStatement("CREATE TABLE IF NOT EXISTS profiles (UUID VARCHAR(36)," +
                        ...
                        "BALANCE DOUBLE, NICK TEXT, MESSAGES BOOLEAN NOT NULL DEFAULT FALSE, MESSAGESOUNDS BOOLEAN NOT NULL DEFAULT FALSE, ACTIVECLASS TEXT, TAG TEXT, COLOR TEXT, BOUNTY BOOLEAN NOT NULL DEFAULT FALSE, BOUNTYAMOUNT DOUBLE, " +
