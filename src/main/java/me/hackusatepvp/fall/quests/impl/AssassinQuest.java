...
public class AssassinQuest extends Quest {

    public AssassinQuest() {
        super("Assassin");
    }
    ...
    public String rankUpMessage() {
        return StringUtil.format("&7You have ranked up to &1ASSASSIN&7.");
    }

    @Override
    public String getPrefix() {
        return StringUtil.format("&7[&1Assassin&7]");
    }
