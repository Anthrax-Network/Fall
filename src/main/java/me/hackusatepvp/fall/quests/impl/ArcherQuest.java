...
public class ArcherQuest extends Quest {
    ...
    public String rankUpMessage() {
        return StringUtil.format("&7You have ranked up to &e&lARCHER&7.");
    }

    @Override
    public String getPrefix() {
        return StringUtil.format("&7[&eArcher&7]");
    }
