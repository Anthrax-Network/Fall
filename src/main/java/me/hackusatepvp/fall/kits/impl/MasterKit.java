...
public class MasterKit extends Kits {
    ...
    public ItemStack getIcon() {
        ...
        itemMeta.setLore(StringUtil.format(Arrays.asList("&7Purchase at &8store.fatekits.net", "&7Unlocks at &8&n15&r&7 kills", "", "&7Delay: " + getColor() + getDelay(), "&7Permission: " + getColor() + getPermission(),
