...
public class DawnTag extends Tags {

    public DawnTag() {
        super(StringUtil.format("&9Dawn &7Tag"));
    }

    @Override
    public String getName() {
        return StringUtil.format("&9Dawn &7Tag");
    }
    ...
    public ItemStack getIcon() {
        ...
        itemMeta.setDisplayName(StringUtil.format("&9Dawn &7Tag"));
